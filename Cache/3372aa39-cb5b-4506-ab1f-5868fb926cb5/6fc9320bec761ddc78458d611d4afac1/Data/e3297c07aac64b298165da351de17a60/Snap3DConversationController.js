...
let Snap3DConversationController = (() => {
    ...
    var Snap3DConversationController = _classThis = class extends _classSuper {
      ...
      `;
        ...
        onAwake() {
            print("🤖 Snap3DConversationController awake (waiting for Start)...");
        }
        onStart() {
            if (!this.snap3DFactoryObj) {
                print("❌ snap3DFactoryObj not assigned!");
                return;
            }
            this.factory = this.snap3DFactoryObj.getComponent(Snap3DInteractableFactory_1.Snap3DInteractableFactory.getTypeName());
            print("🏗️ Factory component ready");
            // Delay NPC spawn slightly to ensure SceneObject initialization
        ...
        spawnNPC(prompt = "Friendly robot with headphones") {
            ...
            this.factory
                ...
                this.initASR();
                this.setSystemContext("A futuristic sci-fi lab on Mars, glowing with holographic machinery. Zyra, a witty alien scientist who studies humans and makes playful observations.");
            })
                .catch((err) => {
