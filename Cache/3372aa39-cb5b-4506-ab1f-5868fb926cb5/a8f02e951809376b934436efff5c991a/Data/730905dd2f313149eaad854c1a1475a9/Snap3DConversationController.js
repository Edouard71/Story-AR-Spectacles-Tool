...
let Snap3DConversationController = (() => {
    ...
    `;
        ...
        spawnNPC(prompt = "Friendly robot with headphones") {
            ...
            this.factory.createInteractable3DObject(prompt).then((msg) => {
                ...
                this.instantiator.notifyOnReady(() => {
                    ...
                    options.onSuccess = (networkRootInfo) => {
                        ...
                        const npcComp = networkedNPC.getComponent(Snap3DInteractable_1.Snap3DInteractable.getTypeName());
                        const localComp = localNPC.getComponent(Snap3DInteractable_1.Snap3DInteractable.getTypeName());
