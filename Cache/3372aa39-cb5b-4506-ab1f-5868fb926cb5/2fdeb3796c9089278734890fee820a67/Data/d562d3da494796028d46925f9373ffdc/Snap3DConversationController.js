...
let Snap3DConversationController = (() => {
    ...
    var Snap3DConversationController = _classThis = class extends _classSuper {
        ...
        startController() {
            ...
            // Set up sync entity
            this.syncEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.npcAssetURLProp, this.npcPromptProp]), true, "Session", null);
        ...
        spawnNPC(prompt = "Friendly robot with headphones") {
            ...
            if (this.isHost || this.role === "Singleplayer") {
                ...
                this.factory.createInteractable3DObject(prompt)
                    ...
                    npcSyncEntity.notifyOnReady(() => print("🔗 NPC SyncEntity ready"));
