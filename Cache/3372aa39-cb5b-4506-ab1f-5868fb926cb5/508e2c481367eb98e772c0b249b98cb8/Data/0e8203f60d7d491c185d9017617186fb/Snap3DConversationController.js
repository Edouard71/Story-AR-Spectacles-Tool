...
let Snap3DConversationController = (() => {
    ...
    var Snap3DConversationController = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.textToSpeech = require("LensStudio:TextToSpeechModule");
        }
        __initialize() {
            super.__initialize();
            this.snap3DFactoryObj = this.snap3DFactoryObj;
        ...
        speak(text) {
            ...
            const opts = this.textToSpeech.Options.create();
            opts.voiceName = this.textToSpeech.VoiceNames.Sam;
            this.textToSpeech.synthesize(text, opts, (audioTrack) => {
