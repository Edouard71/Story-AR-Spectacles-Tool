...
let Snap3DConversationController = (() => {
    ...
    var Snap3DConversationController = _classThis = class extends _classSuper {
        ...
        startController() {
            ...
            // Set up sync entity
            this.syncEntity = new SyncEntity_1.SyncEntity(this, new StoragePropertySet_1.StoragePropertySet([this.npcAssetURLProp, this.npcPromptProp, this.npcPositionProp,
                this.npcRotationProp]), true, "Session", null);
