...
let Snap3DInteractable = (() => {
    ...
    var Snap3DInteractable = _classThis = class extends _classSuper {
        ...
        setupSyncEntity() {
            ...
            this.syncEntity = new SyncEntity_1.SyncEntity(this, propSet, true, "Session", networkIdOptions);
        ...
        startTransformSync() {
            ...
            updateEvent.bind((eventData) => {
                ...
                if (!pos.equal(this.lastPos) || !rot.equal(this.lastRot)) {
                    this.lastPos = pos;
                    this.lastRot = rot;
                    this.syncEntity.sendEvent("npcTransformUpdate", { pos, rot }, false);
                    // Optional: Debug
                    // print(`📤 Sent npcTransformUpdate: ${pos.toString()}`);
                }
            });
        }
        loadFromURL(url) {
