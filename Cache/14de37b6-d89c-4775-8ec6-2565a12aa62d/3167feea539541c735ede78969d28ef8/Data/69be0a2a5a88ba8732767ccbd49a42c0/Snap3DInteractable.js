...
let Snap3DInteractable = (() => {
    ...
    var Snap3DInteractable = _classThis = class extends _classSuper {
        ...
        setInteractionEnabled(enabled) {
            if (this.colliderObj) {
                this.colliderObj.enabled = enabled;
            }
        }
        loadFromURL(url) {
        ...
        setPrompt(prompt) {
            ...
            this.promptDisplay.getTransform().setLocalPosition(new vec3(0, this.size * 0.6 + 24.0, 0));
        }
