...
exports.GetSnapchatUserExample = void 0;
var __selfType = requireType("./GetSnapchatUserExample");
function component(target) { target.getTypeName = function () { return __selfType; }; }
const SessionController_1 = require("../Core/SessionController");
const SyncKitLogger_1 = require("../Utils/SyncKitLogger");
let GetSnapchatUserExample = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var GetSnapchatUserExample = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.log = new SyncKitLogger_1.SyncKitLogger(GetSnapchatUserExample.name);
        }
        __initialize() {
            super.__initialize();
            this.log = new SyncKitLogger_1.SyncKitLogger(GetSnapchatUserExample.name);
        ...
        onReady() {
            ...
            session.getSnapchatUser(localUserInfo, (snapchatUser) => {
                if (!snapchatUser) {
    ...
    __setFunctionName(_classThis, "GetSnapchatUserExample");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        GetSnapchatUserExample = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return GetSnapchatUserExample = _classThis;
})();
exports.GetSnapchatUserExample = GetSnapchatUserExample;
//# sourceMappingURL=GetSnapchatUserExample.js.map