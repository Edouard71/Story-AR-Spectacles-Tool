    ...
    var SceneSetupUI = _classThis = class extends _classSuper {
        ...
        onAwake() {
            ...
            if (this.physicalAsrBtn)
                this.physicalAsrBtn.onQueryEvent.add((text) => this.handleQuery("physical", text));
            if (this.personalityAsrBtn)
                this.personalityAsrBtn.onQueryEvent.add((text) => this.handleQuery("personality", text));
            if (this.sceneAsrBtn)
                this.sceneAsrBtn.onQueryEvent.add((text) => this.handleQuery("scene", text));
            // hook up run-scene
            this.runSceneBtn
