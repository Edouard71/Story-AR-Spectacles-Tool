...
let SceneSetupUI = (() => {
    ...
    var SceneSetupUI = _classThis = class extends _classSuper {
        ...
        initConnections() {
            ...
            this.physicalAsrBtn.onQueryEvent.add((t) => this.handleQuery("physical", t));
            this.personalityAsrBtn.onQueryEvent.add((t) => this.handleQuery("personality", t));
            this.sceneAsrBtn.onQueryEvent.add((t) => this.handleQuery("scene", t));
