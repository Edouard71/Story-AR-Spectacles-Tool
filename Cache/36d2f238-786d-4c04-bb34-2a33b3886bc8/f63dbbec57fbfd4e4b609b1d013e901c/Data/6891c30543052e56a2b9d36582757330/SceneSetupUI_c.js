...
// @input Component.ScriptComponent runScenePinchBtn
...
var Module = require("../../../../Modules/Src/Assets/Scripts/SceneSetupUI");
Object.setPrototypeOf(script, Module.SceneSetupUI.prototype);
script.__initialize();
let awakeEvent = script.createEvent("OnAwakeEvent");
awakeEvent.bind(() => {
    checkUndefined("conversationController", []);
    ...
    checkUndefined("runScenePinchBtn", []);
    if (script.onAwake) {
       script.onAwake();
    }
});
