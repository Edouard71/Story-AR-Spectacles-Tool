...
import { PinchButton } from "SpectaclesInteractionKit.lspkg/Scripts/Components/PinchButton/PinchButton";
...
export class SceneSetupUI extends BaseScriptComponent {
  ...
  // Run Scene button
    @input("Component.ScriptComponent") runScenePinchBtn: PinchButton;
  ...
  private init() {
    ...
    if (this.runScenePinchBtn && this.runScenePinchBtn.onButtonPinched) {
    this.runScenePinchBtn.onButtonPinched.add(() => this.runScene());
    print("🎬 Run Scene pinch button bound!");
    } else {
    print("⚠️ Run Scene pinch button missing or invalid component.");
    }
